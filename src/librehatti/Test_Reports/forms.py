...
class Soil_ohsr_Des(forms.ModelForm):
    ...
    def __init__(self,  *args, **kwargs):
        super(Soil_ohsr_Des, self).__init__(*args, **kwargs)
        self.fields['dt'].widget.attrs = {'class':'Dt'}
        self.fields['ob_pr'].widget.attrs = {'class':'Ob_Pr'}
        self.fields['corr_f'].widget.attrs = {'class':'Corr_F'}
        self.fields['ob_n_v'].widget.attrs = {'class':'Ob_N_V'}
...
class Soil_bridge_Des(forms.ModelForm):
    ...
    def __init__(self,  *args, **kwargs):
        super(Soil_bridge_Des, self).__init__(*args, **kwargs)
        self.fields['p_matretain'].widget.attrs = {'class':'p_matretain'}
        self.fields['p_product'].widget.attrs = {'class':'p_product'}
        self.fields['dt'].widget.attrs = {'class':'Dt'}
        self.fields['ob_pr'].widget.attrs = {'class':'Ob_Pr'}
        self.fields['corr_f'].widget.attrs = {'class':'Corr_F'}
        self.fields['ob_n_v'].widget.attrs = {'class':'Ob_N_V'}
